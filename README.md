...
Back_Upper / 後頭部上層とBack_Middle / 後頭部中層の配置点は、後頭部ガイドCurveに追従しますが、ガイド線上には生成されません。Back_Upperは後頭部ガイド位置から頭頂部方向へ35%補完され、Back_Middleは後頭部ガイド位置から襟足方向へ30%補完されます。補完後の位置を後頭部外側へ少し押し出すことで、頭部内部へ大きく埋まることを避けつつ、上層・中層が同一線上に重ならない髪の層構造を作ります。Back_Middleは左右ペアの対称配置も維持します。
